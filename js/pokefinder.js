...
$(document).ready(function ()
{
	$('#stopsTable').DataTable(
	{
		...
		{
			"search": "Filter results:",
			"info": "Showing _START_ to _END_ of _TOTAL_ Stops",
			"infoEmpty": "Showing 0 to 0 of 0 Stops",
			"infoFiltered": "(filtered from _MAX_ total Stops)",
			"emptyTable": "No Stops available in table",
			"zeroRecords": "No matching Stops found",
			"searchPlaceholder": "Enter info",
			"lengthMenu": "Show _MENU_ Stops per page",
		},
		"dom": '<"top"fl>rt<"bottom"p><"clear">'
...
$(document).ready(function ()
{
	$('#gymsTable').DataTable(
	{
		...
		language:
		{
			...
			"infoEmpty": "Showing 0 to 0 of 0 Gyms",
			"infoFiltered": "(filtered from _MAX_ total Gyms)",
			"emptyTable": "No Gyms available in table",
			"zeroRecords": "No matching Gyms found",
			"searchPlaceholder": "Enter info",
