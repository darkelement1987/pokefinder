...
?>
<tr>
<td class="align-middle"><img src="<?=$assetRepo?>pokemon_icon_<?=str_pad($row->pokemon_id, 3, 0, STR_PAD_LEFT)?>_<?=str_pad($row->form, 2, 0, STR_PAD_LEFT)?>.png" height="46" width="46"> <a href="index.php?page=seen&pokemon=<?=$row->pokemon_id?>&form=<?=$row->form?>" height="32" width="32"> <?=$monname[$row->pokemon_id]['name']?></a></td>
